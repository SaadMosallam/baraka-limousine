...
export const limousineCairoAr: SeoLandingPageContent = {
  ...
  metaTitle: "خدمات ليموزين في القاهرة | البركة ليموزين",
  metaDescription:
    "احجز خدمات ليموزين في القاهرة لرحلات الأعمال والتنقل اليومي وسيارة بسائق مع سائقين محترفين وأسعار واضحة. تواصل مع البركة ليموزين للحجز السريع.",
  h1: "خدمات ليموزين في القاهرة للأعمال والتنقل الخاص براحة وأمان",
  schema: {
...
export const cairoAirportAr: SeoLandingPageContent = {
  ...
  metaTitle: "ليموزين مطار القاهرة | نقل من وإلى المطار | البركة ليموزين",
  metaDescription:
    "خدمة ليموزين مطار القاهرة ونقل من وإلى المطار مع استقبال وتوديع ومتابعة رحلات عند الطلب ومركبات مناسبة للحقائب. احجز مع البركة ليموزين.",
